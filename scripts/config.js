/*
    Configuração da API
    -------------------
    Aqui fica o endereço do nosso backend (o servidor Node.js
    que fala com o MongoDB Atlas).

    - Testando no seu computador (com "npm start" rodando local): use localhost.
